...
import { fetchBreakingArticles, fetchRootCategories } from '@/app/utils/serverApi';

export default function TrendingArticlesPage({ initialArticles = [] }) {
    ...
    useEffect(() => {
        const loadSidebarData = async () => {
            try {
                const [breakingRes, rootCategoriesRes] = await Promise.all([
                    fetchBreakingArticles(5),
                    fetchRootCategories()
                ]);

                setSidebarData({
                    breakingArticles: breakingRes.success ? breakingRes.data?.newArticles || [] : [],
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-lg">
                                    Stay updated with the most popular and trending stories
                                </p>
                            </div>
                        </div>
                    ...
                    {pagination && (
                        <div className="flex flex-wrap gap-6 mt-6 pt-6 border-t border-gray-200">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700">Most Viewed</span>
                            </div>
                        </div>
                    )}
                </div>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                                ...
                                <CardBody className="py-20 px-8">
                                    <div className="max-w-md mx-auto text-center">
                                        <div className="relative mb-8 inline-block">
                                            <div className="absolute inset-0 bg-orange-500/10 rounded-full blur-2xl animate-pulse"></div>
                                            <div className="relative w-24 h-24 bg-linear-to-br from-orange-100 to-red-100 rounded-3xl flex items-center justify-center mx-auto shadow-lg">
                                        ...
                                        <p className="text-gray-600 text-base md:text-lg mb-8 leading-relaxed">
                                            There are no trending articles at the moment. Check back soon for the latest trending stories.
                                        </p>
                                        <Button
                                            color="primary"
                                            variant="solid"
                                            ...
                                            as={Link}
                                            href="/"
                                            className="font-semibold px-8 shadow-lg shadow-orange-500/30"
                    ...
                    <aside className="w-full lg:w-1/3 space-y-6 lg:sticky lg:top-32 lg:self-start">
                        {/* Breaking News */}
                        <TrendingArticles
                            articles={sidebarData.breakingArticles || []}
                            title="Breaking News"
                        />
