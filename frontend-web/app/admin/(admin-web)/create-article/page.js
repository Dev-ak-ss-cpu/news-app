...
export default function ArticleEditor({ articleId = null }) {
    ...
    const loadArticle = async () => {
        ...
        setTimeout(() => {
            setArticle({
                ...
                content: 'This is the main content of the article. You can edit this text to update the article content.',
                excerpt: 'This is a brief excerpt of the article that will be shown in previews.',
                category: '4', // Country
                subCategory: '1', // Kathmandu
    ...
    const loadDistricts = async (categoryId) => {
        if (categoryId === '4') { // Country category
            try {
                    ...
                    <Card className="bg-white border border-gray-200 shadow-sm">
                        <CardHeader className="pb-0">
                            <div className="flex items-center gap-2 border-b border-gray-200 pb-3">
                                <Button isIconOnly size="sm" variant="light" onPress={() => formatText('bold')}>
                                    <Bold size={16} />
                                </Button>
                                <Button isIconOnly size="sm" variant="light" onPress={() => formatText('italic')}>
                                    <Italic size={16} />
                                </Button>
                                <Divider orientation="vertical" className="h-6" />
                                <Button isIconOnly size="sm" variant="light" onPress={() => formatText('insertUnorderedList')}>
                                    <List size={16} />
                                </Button>
                                <Button isIconOnly size="sm" variant="light" onPress={() => formatText('insertOrderedList')}>
                                    <ListOrdered size={16} />
                                </Button>
                                <Button isIconOnly size="sm" variant="light" onPress={() => insertText('" "')}>
                                    <Quote size={16} />
                                </Button>
                                <Divider orientation="vertical" className="h-6" />
                                <Button isIconOnly size="sm" variant="light" onPress={onImageModalOpen}>
                                    <ImageIcon size={16} />
                                </Button>
                                <Button isIconOnly size="sm" variant="light" onPress={onVideoModalOpen}>
                                    <Youtube size={16} />
                                </Button>
                                <Button isIconOnly size="sm" variant="light" onPress={() => insertText('[Insert Link]')}>
                                    <Link size={16} />
                                </Button>
                            </div>
                        </CardHeader>
                        <CardBody className="p-0">
                            <Textarea
                                ...
                                className="w-full min-h-[400px] border-none p-6 focus:ring-0 resize-none"
                                minRows={20}
                            />
                        </CardBody>
                    </Card>
                            ...
                            {article.youtubeVideo ? (
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <p className="text-sm text-gray-700 flex-1 truncate">{article.youtubeVideo}</p>
                                    </div>
                                    <div className="flex gap-2">
                                        <Button
                                            variant="bordered"
